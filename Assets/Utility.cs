...
public class Utility : MonoBehaviour
{
    ...
    public static Mesh GenerateOceanPlane(int meshResolution, float scale, bool saveToProject = false, bool useXZplane = true)
    {
        ...
        if (saveToProject)
        {
            AssetDatabase.CreateAsset(mesh, "Assets/Plane.asset");
